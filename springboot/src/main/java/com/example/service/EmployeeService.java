...
public class EmployeeService {
    ...
    public void add(Employee employee) {
        ...
        if (ObjectUtil.isEmpty(employee.getLever())){
            employee.setLever(LeverEnum.EMPLOYEE.lever);
        }
    ...
    public String getName(String assigneeName) {
        return employeeMapper.getName(assigneeName);
    }

    public Employee selectByName(String assignee) {
        return employeeMapper.selectByName(assignee);
    }
}