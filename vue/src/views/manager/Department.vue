    ...
    <el-dialog title="信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="description" label="部门描述">
          ...
          <el-form-item prop="description" label="部长名称">
          <el-select v-model="form.employeeId"  placeholder="请选择部长"  style="width: 100%">
              <el-option v-for="item in headData":label="item.name" :value="item.id"></el-option>
          </el-select>
          </el-form-item>
      </el-form>
