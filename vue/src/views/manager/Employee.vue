...
<!--        <el-table-column prop="role" label="角色"></el-table-column>-->
        <el-table-column prop="lever" label="身份"></el-table-column>
    ...
    <el-dialog title="管理员" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        ...
        <el-form-item label="邮箱" prop="email">
          ...
          <el-form-item label="部门" prop="lever">
          ...
          <el-form-item label="身份" prop="lever">
              <el-select v-model="form.lever" placeholder="请选择身份" style="width: 100%">
